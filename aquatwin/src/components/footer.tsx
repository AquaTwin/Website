    ...
    <section className="p-4 px-8 dark bg-primary-2 text-text sticky bottom-0 left-0 -z-10 w-screen text-center md:text-left">
      <div className="mb-3 flex flex-col md:flex-row justify-around gap-3">
        <div className=" flex flex-col items-center md:items-start">
          <Image
            ...
            className="w-auto"
          />
          <p className=" hidden md:block max-w-[300px] text-sm">
            The AquaTwin project aims to revolutionize the management of
            transboundary river basins in Kenya by integrating satellite data
        ...
        <div className=" flex flex-col  items-center">
          ...
          <div className=" flex">
            {/* <span className=" mr-3 min-w-14">JKUAT</span> */}
            <ul className=" flex gap-3 items-center">
              <li>
                <a href="https://www.jkuat.ac.ke/" target="_blank">
                  <Image
                    alt="JKUAT"
                    src="/partners/jkuat.png"
                    height={40}
                    width={45}
                  />
                </a>
            ...
            <ul className=" flex gap-3"> */}
              <li>
                <a
                  href="https://www.facebook.com/DiscoverJKUAT"
                  target="_blank"
                >
                  <svg
              ...
              <li>
                <a href="https://x.com/discoverjkuat" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="h-[20px] w-[20px] fill-[#809cce]"
              ...
              <li>
                <a
                  href="https://www.linkedin.com/school/jkuat/"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className=" flex mt-3 md:mt-4">
            {/* <span className=" mr-3 min-w-14">JHUB</span> */}
            <ul className=" flex gap-3 items-center">
              <li>
              ...
              <li>
                <a href="https://www.facebook.com/JHUBAfrica/" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="h-[20px] w-[20px] fill-[#809cce]"
              ...
              <li>
                <a href="https://x.com/JHUBAfrica" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="h-[20px] w-[20px] fill-[#809cce]"
      ...
      <footer className="mt-3 flex justify-between flex-col md:flex-row items-center gap-2">
        ...
        <div className=" flex gap-3">
          ...
          <a href="https://github.com/AquaTwin" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="h-[20px] w-[20px] fill-[#809cce]"
          ...
          <a href="mailto:aquatwin254@gmail.com" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="h-[20px] w-[20px] fill-[#809cce]"
